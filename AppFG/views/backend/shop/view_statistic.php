                ...
                <div class="box-body table-responsive">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <select class="form-control select2 store_id select2-hidden-accessible" multiple="" data-placeholder="Select a store" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="col-md-12" style="margin-top:30px">
                            ...
                            <select class="form-control select2 status_process select2-hidden-accessible" multiple="" data-placeholder="Select a order process" tabindex="1" aria-hidden="true">
                                <?php foreach ($setting_shop_order_status as $status_process) : ?>
                                    <option value="<?php echo $status_process['status']; ?>"><?php echo $status_process['text']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
